...
**Version:** 0.2.0 · **Package:** `@trustscope/sdk` · **Node.js:** 18+
...
The SDK defaults to `failOpen: true` — your agent continues working even if TrustScope is unavailable. Set `failOpen: false` for strict enforcement.
:::
