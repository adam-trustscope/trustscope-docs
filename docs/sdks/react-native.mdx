...
**Version:** 0.1.0 · **Package:** `@trustscope/react-native` · **React Native:** 0.70+
...
The SDK defaults to `failOpen: true` — your app continues working even if TrustScope is unavailable. An `OfflineQueue` automatically caches and syncs requests when connectivity returns.
:::
