...
|------|-------|-------------|
| **Monitor** | Free | 16 detection engines, alerts, 30-day retention |
| **Protect** | $49/mo | +4 ML engines, blocking/redact, BYOLLM, 90-day retention |
| **Enforce** | $199/mo | +6 AI engines, 24 policy types, 1-year retention |
| **Govern** | Contact Sales | Evidence Room, ZKP, PGC, Docker, BYOK, 7-year retention |
...
**Unlock:** Blocking/redact, BYOLLM, +4 ML engines (prompt injection, jailbreak, toxicity, hate speech), Slack alerts, 90-day retention

**When:** You need to actually stop bad actions, not just detect them

### Protect → Enforce ($199/mo)
**Unlock:** +6 AI-hybrid engines, 24 policy types, human approvals, MCP governance, Agent Lock, 1-year retention
