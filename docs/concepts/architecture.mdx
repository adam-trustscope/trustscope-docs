...
├───────────────────────────────────────────────────────────────┤
│         Layer 6: Enforcement                                  │
│    24 policy types, blocking, approval, simulate mode         │
├───────────────────────────────────────────────────────────────┤
│         Layer 5: Detection                                    │
│    26 engines across 4 categories                             │
├───────────────────────────────────────────────────────────────┤
│         Layer 4: Identity                                     │
...
### 26 Detection Engines

**Statistical (10) — Monitor:** Loop Killer, Velocity, Oscillation, Token Growth, Cost Velocity, Error Rate, Budget Caps, Context Expansion, Session Duration, Session Action Limit

**Pattern / Content (6) — Monitor:** PII Scanner, Secrets Scanner, Command Firewall, Blocked Phrases, Data Exfiltration, Action Label Mismatch

**ML Content (4) — Protect:** Prompt Injection (Prompt Guard 2), Jailbreak Detector (Prompt Guard 2), Toxicity Filter (Detoxify), Hate Speech Detector (HateBERT)

**AI Hybrid (6) — Enforce:** Semantic Firewall, Hallucination, Reasoning Drift, A2A Depth, Tool Parameter Validator, Reasoning Quality Monitor
...
1. Create in `off` or `simulate` mode
2. Review simulate results
3. Enable `alert` for notifications
4. Activate `block` for enforcement
