...
|----------|--------|--------|
| **OpenAI** | GPT-5.2, o3, o1 | ✅ Full Support |
| **Anthropic** | Claude Opus 4.6, Sonnet 4.5, Haiku 4.5 | ✅ Full Support |
| **Google** | Gemini 3, Gemini 2.5 | ✅ Full Support |
| **Mistral** | Mistral Large 2, Codestral | ✅ Full Support |
| **Cohere** | Command R+, Command R | ✅ Full Support |
| **Azure OpenAI** | All Azure-hosted OpenAI models | ✅ Full Support |
| **AWS Bedrock** | Claude 4.5, Titan, Llama 3.3 via Bedrock | ✅ Full Support |
| **Groq** | Llama 3.3 70B, Mixtral | ✅ Full Support |
| **Together AI** | Llama 3.3, Mixtral, open-source models | ✅ Full Support |
| **Perplexity** | Sonar Pro, Sonar | ✅ Full Support |
| **[Any OpenAI-compatible](/docs/gateway/custom-providers)** | xAI Grok, Fireworks, vLLM, Ollama | ✅ Via Generic Proxy |

:::warning Recent Model Changes
- **OpenAI**: GPT-4o retired February 13, 2026. Use `gpt-5.2` or `o3`.
- **Google**: Gemini 2.0 deprecated, ends March 31, 2026. Use Gemini 2.5+.
:::
...
response = client.chat.completions.create(
    model="gpt-5.2",  # or "o3" for reasoning tasks
...
response = client.messages.create(
    model="claude-sonnet-4-5-20251124",  # or claude-opus-4-6-20260205 for complex tasks
    max_tokens=1024,
    messages=[{"role": "user", "content": "Hello!"}]
)
```
...
response = client.chat.completions.create(
    model="gemini-2.5-pro",  # or gemini-3-pro for latest
    messages=[{"role": "user", "content": "Hello!"}]
)
```

:::tip Gemini Native SDK Support
We also support the native Gemini SDK via our Python SDK. See [Gemini Integration Guide](/docs/gateway/google-gemini) for details.
:::
...
| Groq | `gateway.trustscope.ai/groq` | OpenAI-compatible |
| Together AI | `gateway.trustscope.ai/together` | OpenAI-compatible |
| Perplexity | `gateway.trustscope.ai/perplexity` | OpenAI-compatible |
| Any OpenAI-compatible | `gateway.trustscope.ai/proxy` | OpenAI-compatible |
